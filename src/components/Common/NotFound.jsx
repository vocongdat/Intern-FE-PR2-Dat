...
const NotFound = () => {
    ...
    const animeNotFound = anime.timeline();
    animeNotFound
        .add({
            targets: '.row svg',
            translateY: 10,
    ...
    return (
        <div className={classes.root}>
            <a href='https://github.com/vocongdat' target='_blank' rel='noreferrer'>
                        ...
                        <div className='col-sm-12 col-md-12 mt-5 mb-5'>
                            ...
                            >
                                <g id='OBJECTS'>
                                    ...
                                    <g id='zero' className={classes.zero}>
                                        <path
                                            id='Vector_25'
                                    ...
                                    <g id='Group_8'>
                                        <g id='Group_9'>
                                            ...
                                            />
                                            <g id='handboy' className={classes.handBoy}>
                                                <path
                                                    id='Vector_32'
                                    ...
                                    <g id='Group_13'>
                                        <g id='Group_14'>
                                            ...
                                            <path
                                                ...
                                                fill='black'
                                            />
                                            <g id='girllight' className={classes.girlLight}>
                                                <path
                                                    id='Vector_102'
                                            ...
                                            <path
                                                ...
                                                fill='black'
                                            />
                                            <g id='hairgirl' className={classes.hairGirl}>
                                                <path
                                                    id='Vector_108'
